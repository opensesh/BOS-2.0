...
export function SavedArticlesDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 bottom-0 w-[480px] max-w-[95vw] bg-os-bg-darker border-l border-os-border-dark z-50 flex flex-col animate-slide-in-right">
        {/* Header */}
        ...
        {/* Filters & Sort */}
        <div className="px-5 py-3 border-b border-os-border-dark/50 space-y-3">
          {/* Sort Controls */}
          <div className="flex items-center gap-2">
