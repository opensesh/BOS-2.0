    ...
    <div className="p-6">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-xs text-os-text-secondary-dark">{enabledCount} sources active</p>
        </div>
      </div>
      ...
      {/* Add New Source */}
      {showAddForm ? (
        <div className="p-4 bg-os-bg-dark rounded-xl border border-os-border-dark mt-6">
