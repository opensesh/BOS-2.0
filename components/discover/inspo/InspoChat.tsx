      ...
      >
        <div className="relative">
          <textarea
            ...
            className="w-full px-4 py-3 bg-transparent text-os-text-primary-dark placeholder:text-os-text-secondary-dark resize-none focus:outline-none min-h-[48px] max-h-[120px] text-sm"
            rows={1}
        ...
        {/* Toolbar */}
        <div className="flex items-center justify-end px-3 py-2 border-t border-os-border-dark gap-2">
          {/* Voice Input */}
          <div className="relative">
            {isListening && (
              <>
