...
import { Source, NewsCardData, InspirationCardData, NewsData, InspirationData } from '@/types';
...
function generateContentFromTitle(title: string, description?: string): string[] {
  ...
  content.push(title + '. ' + (description || 'This article explores the latest developments and insights in this area.'));
  
  // Second paragraph - generic industry context
  content.push('Industry experts have been closely monitoring these developments, noting the potential implications for businesses and consumers alike. The trend reflects broader changes in how technology and design intersect with everyday experiences.');
  
  // Third paragraph - forward-looking statement
  content.push('As this space continues to evolve, we can expect to see more innovations that push the boundaries of what\'s possible. Stay tuned for more updates as we continue to track these developments.');
    ...
    return (
      <div className="flex h-screen bg-os-bg-dark text-os-text-primary-dark items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-display font-bold text-brand-vanilla mb-4">Article Not Found</h1>
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="flex-1 min-w-0">
                <ArticleHeader 
                  ...
                  sourceCount={articleData.sources.length}
                />

                {/* Hero Image */}
                {ogImage && (
                  <div className="relative aspect-[16/9] overflow-hidden rounded-xl mb-8 bg-os-surface-dark">
                    <Image
                      src={ogImage}
                ...
                <SourceCards sources={articleData.sources} />
              ...
              <div className="hidden lg:block w-64 shrink-0">
                <div className="sticky top-8">
                  ...
                  <ArticleSidebar summaryPoints={articleData.summaryPoints || []} />
                </div>
              </div>
            </div>
          </div>
